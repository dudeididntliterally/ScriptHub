...
local Window = OrionLib:MakeWindow({Name = "Zacks Cool Hub | Tower Of Hell", HidePremium = true, IntroText = "Zacks Cool Hub dominating someday?", SaveConfig = false, ConfigFolder = "TOH"})
