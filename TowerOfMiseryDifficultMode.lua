...
local Window = OrionLib:MakeWindow({Name = "Zacks Cool Hub | Tower Of Misery (Difficult Mode)", HidePremium = true, IntroText = "Best Script For This Game!", SaveConfig = false, ConfigFolder = "ZCH (Difficult Mode)"})
...
Name = "TP To Top (win)",
Callback = function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(77.4960403, 503.999908, 49.0301094)
end})
...
local teleport_table = {
    location1 = Vector3.new(77.4960403, 503.999908, 49.0301094, 1, 0, 0, 0, 1, 0, 0, 0, 1)
}
